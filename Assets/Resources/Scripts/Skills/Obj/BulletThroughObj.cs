...
public class BulletThroughObj : SkillObjBase
{
    ...
    public override void ObjInit(Vector2 _dir, int _dmg, int _stunDmg, string _tag, ISkillCaster _caster, bool _reinforced, SkillBase parentSkill)
    {
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (this.gameObject.tag != other.gameObject.tag)
        {
            ...
            if (reinforced)
            {
                ...
                enemyUnit.AddEffectProcess(new DeBuff_LatedDamage(.5f, other.GetComponent<Unit>(), "LatedDamage", caster.GetGameObject(), dmg, stunDmg));
            }
        }
    }
}
